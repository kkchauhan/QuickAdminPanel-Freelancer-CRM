...
<body class="sidebar-mini layout-fixed" style="height: auto;">
    <div class="wrapper">
            ...
            <ul class="navbar-nav ml-auto align-items-center">
                @if(count(config('panel.available_languages', [])) > 1)
                    <li class="nav-item dropdown">
                        <a class="nav-link" data-toggle="dropdown" href="#">
                            <i class="fas fa-globe mr-1"></i> {{ strtoupper(app()->getLocale()) }}
                        </a>
                ...
                <li class="nav-item">
                    <a class="nav-link" href="#" onclick="event.preventDefault(); document.getElementById('logoutform').submit();">
                        <i class="fas fa-sign-out-alt mr-1"></i> <span class="d-none d-sm-inline">{{ trans('global.logout') }}</span>
                    </a>
                </li>
            </ul>
        </nav>
        ...
        <footer class="main-footer">
            ...
            <span>&copy; {{ date('Y') }} {{ trans('panel.site_title') }}</span> &mdash; {{ trans('global.allRightsReserved') }}
        </footer>
    ...
    <script src="{{ asset('js/crm-theme.js') }}"></script>
